...
$sql = "SELECT * FROM communes_departement_region WHERE COL10 LIKE (:var) or COL3 LIKE (:var) or COL13 LIKE (:var) ORDER BY COL10 ASC LIMIT 0, 10";  // création de la requete avec sélection des résultats sur la lettre 
$req = $con->prepare($sql);
