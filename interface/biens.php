...
<body>
    <header>
        ...
        <ul class="navbar">
            ...
            <li><a href="#" class="active"><i class="fa-solid fa-thumbtack" style="color: #1b5eaf;"></i> Nos biens</a></li>
            <li><a href="contact.html"><i class="fa-solid fa-address-book" style="color: #1b5eaf;" ></i> Contact</a></li>
            <li style="font-size: 1.1rem;" class="search-bar" onclick="afficherInterfaceRecherche()"><i class="fa-solid fa-search"></i><pre> </pre>Filtres</li>
        </ul>
    ...
    <div id="interface-recherche" 
        ...
        z-index: 999;
        background: #eeeeee;">
        <h3 style="text-align: center;">Options de filtrage :</h3>
        <br>
        <hr>
        <br>
        <br>
    ...
    <section class="une-section">
        <h2 class="liste-biens">Liste de nos biens :</h2>   
    </section>
...
?> 
    ...
    <script>
        ...
        function afficherInterfaceRecherche() {
            ...
            if (interfaceRecherche.style.display === "none") {
                interfaceRecherche.style.display = "block";
            } else {
                interfaceRecherche.style.display = "none";
            }
        }
    </script>
